...
class SocialNetworksItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('socialnetworks_item_err_ns');
        }
...
return 'SocialNetworksItemUpdateProcessor';
